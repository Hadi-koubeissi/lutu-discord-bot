...
class Serverinfo extends Command {
  ...
  async run (message, args, level, reply) { // eslint-disable-line no-unused-vars
    ...
    const afkServerInfo = message.guild.channels.cache.get(message.guild.afkChannelID) === undefined ? "None" : message.guild.channels.cache.get(guildmessageServerInfo.afkChannelID).name;
